...
*/
var Ryan = User(name: "Ryan", age: 22, height: 6.00, weight: 200.00, activityLevel: 0.00)
/*:
...
*/
var otherDis = Distance(meters: 0.0, feet: 0.00)
/*:
...
var workout = RunningWorkout(distance: 1.00, time: 60.00, elevation: 100.00)
...
var step = Steps(steps: 999, goal: 1000)
step.takeStep()
